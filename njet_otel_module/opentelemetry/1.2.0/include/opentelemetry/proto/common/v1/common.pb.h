...
inline void AnyValue::_internal_set_bytes_value(const std::string& value) {
  ...
  value_.bytes_value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void AnyValue::set_bytes_value(const char* value) {
  ...
  value_.bytes_value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
      ::std::string(value), GetArena());
...
inline std::string* AnyValue::release_bytes_value() {
  ...
  if (_internal_has_bytes_value()) {
    clear_has_value();
    return value_.bytes_value_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  } else {
    return nullptr;
  }
}
