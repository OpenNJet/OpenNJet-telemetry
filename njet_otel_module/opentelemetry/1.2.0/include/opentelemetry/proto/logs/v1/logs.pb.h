...
inline void InstrumentationLibraryLogs::set_schema_url(const std::string& value) {
  _internal_set_schema_url(value);
...
inline void InstrumentationLibraryLogs::set_schema_url(std::string&& value) {
  
  schema_url_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:opentelemetry.proto.logs.v1.InstrumentationLibraryLogs.schema_url)
}
inline void InstrumentationLibraryLogs::set_schema_url(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  schema_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:opentelemetry.proto.logs.v1.InstrumentationLibraryLogs.schema_url)
}
inline void InstrumentationLibraryLogs::set_schema_url(const char* value,
    size_t size) {
  ...
  schema_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:opentelemetry.proto.logs.v1.InstrumentationLibraryLogs.schema_url)
}
