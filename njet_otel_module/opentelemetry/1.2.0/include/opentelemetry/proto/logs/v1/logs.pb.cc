...
class LogsDataDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<LogsData> _instance;
...
static void InitDefaultsscc_info_LogsData_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::opentelemetry::proto::logs::v1::_LogsData_default_instance_;
    new (ptr) ::opentelemetry::proto::logs::v1::LogsData();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_LogsData_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_LogsData_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto}, {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::opentelemetry::proto::logs::v1::LogsData)},
  { 6, -1, sizeof(::opentelemetry::proto::logs::v1::ResourceLogs)},
  { 14, -1, sizeof(::opentelemetry::proto::logs::v1::InstrumentationLibraryLogs)},
  { 22, -1, sizeof(::opentelemetry::proto::logs::v1::LogRecord)},
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto_sccs[4] = {
  &scc_info_InstrumentationLibraryLogs_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto.base,
  &scc_info_LogRecord_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto.base,
  &scc_info_LogsData_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto.base,
  &scc_info_ResourceLogs_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto = {
  false, false, descriptor_table_protodef_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto, "opentelemetry/proto/logs/v1/logs.proto", 1887,
  &descriptor_table_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto_once, descriptor_table_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto_sccs, descriptor_table_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto_deps, 4, 2,
  schemas, file_default_instances, TableStruct_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto::offsets,
  file_level_metadata_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto, 4, file_level_enum_descriptors_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto, file_level_service_descriptors_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto,
};
...
void LogsData::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LogsData_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto.base);
}
...
const LogsData& LogsData::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_LogsData_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto.base);
...
::PROTOBUF_NAMESPACE_ID::uint8* LogsData::_InternalSerialize(
...
void LogsData::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:opentelemetry.proto.logs.v1.LogsData)
  GOOGLE_DCHECK_NE(&from, this);
  const LogsData* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<LogsData>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:opentelemetry.proto.logs.v1.LogsData)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:opentelemetry.proto.logs.v1.LogsData)
    MergeFrom(*source);
  }
}
...
void LogsData::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:opentelemetry.proto.logs.v1.LogsData)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
