...
test/CMakeFiles/test-convenience.dir/src/unit-convenience.cpp.o: ../test/src/unit-convenience.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/test-convenience.dir/src/unit-convenience.cpp.o"
	cd /telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/test && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-convenience.dir/src/unit-convenience.cpp.o -c /telemetry/opentelemetry-cpp/third_party/nlohmann-json/test/src/unit-convenience.cpp
...
test/CMakeFiles/test-convenience.dir/src/unit-convenience.cpp.i: cmake_force
	...
	cd /telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /telemetry/opentelemetry-cpp/third_party/nlohmann-json/test/src/unit-convenience.cpp > CMakeFiles/test-convenience.dir/src/unit-convenience.cpp.i
...
test/CMakeFiles/test-convenience.dir/src/unit-convenience.cpp.s: cmake_force
	...
	cd /telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /telemetry/opentelemetry-cpp/third_party/nlohmann-json/test/src/unit-convenience.cpp -o CMakeFiles/test-convenience.dir/src/unit-convenience.cpp.s
...
test/test-convenience: test/CMakeFiles/test-convenience.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test-convenience"
	cd /telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-convenience.dir/link.txt --verbose=$(VERBOSE)
