...
test/CMakeFiles/test-modifiers.dir/src/unit-modifiers.cpp.o: ../test/src/unit-modifiers.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/test-modifiers.dir/src/unit-modifiers.cpp.o"
	cd /telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/test && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test-modifiers.dir/src/unit-modifiers.cpp.o -c /telemetry/opentelemetry-cpp/third_party/nlohmann-json/test/src/unit-modifiers.cpp
...
test/CMakeFiles/test-modifiers.dir/src/unit-modifiers.cpp.i: cmake_force
	...
	cd /telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /telemetry/opentelemetry-cpp/third_party/nlohmann-json/test/src/unit-modifiers.cpp > CMakeFiles/test-modifiers.dir/src/unit-modifiers.cpp.i
...
test/CMakeFiles/test-modifiers.dir/src/unit-modifiers.cpp.s: cmake_force
	...
	cd /telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /telemetry/opentelemetry-cpp/third_party/nlohmann-json/test/src/unit-modifiers.cpp -o CMakeFiles/test-modifiers.dir/src/unit-modifiers.cpp.s
...
test/test-modifiers: test/CMakeFiles/test-modifiers.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test-modifiers"
	cd /telemetry/opentelemetry-cpp/third_party/nlohmann-json/build/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-modifiers.dir/link.txt --verbose=$(VERBOSE)
