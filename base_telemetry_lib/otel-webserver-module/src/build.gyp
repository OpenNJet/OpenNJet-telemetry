{
  'targets': [{
    ...
    'sources': [
      ...
      'core/api/opentelemetry_njt_api.cpp',
    ...
    'conditions': [
      ['OS=="linux"', {
        ...
        'libraries': [
          '$(ANSDK_DIR)/apr/1.7.4/lib/libapr-1.a',
          ...
          '/dependencies/baselib/liblog4cxx.so.10',
          '/dependencies/baselib/libopentelemetry_common.so',
          '/dependencies/baselib/libopentelemetry_resources.so',
          '/dependencies/baselib/libopentelemetry_trace.so',
          '/dependencies/baselib/libopentelemetry_otlp_recordable.so',
          '/dependencies/baselib/libopentelemetry_exporter_ostream_span.so',
          '/dependencies/baselib/libopentelemetry_exporter_otlp_grpc.so',
          '$(BOOST_LIB)',
          '$(LINKER_FLAGS)',
          '$(LIBRARY_FLAGS)',
        ],
