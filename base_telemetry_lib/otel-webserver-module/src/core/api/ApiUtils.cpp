...
OTEL_SDK_STATUS_CODE ApiUtils::init_boilerplate(char *prefix, size_t prefix_len)
{
    try
    {
		...
		{
			tmp_prefix[i] = prefix[i];
		}
		logConfigPath = boost::filesystem::path(tmp_prefix)
